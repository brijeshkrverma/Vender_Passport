const service = require('./requirement.service');
...
exports.getByFramework = async (req, res, next) => {
  try { response.success(res, await service.getByFramework(req.params.frameworkId, req.user.scopeOrgId)); } catch(e) { next(e); }
};
